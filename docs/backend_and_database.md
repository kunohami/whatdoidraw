...
Como red colaborativa Open Source con alta demanda de subidas, hemos configurado políticas estrictas para evitar el colapso del sistema de almacenamiento `Supabase Storage`:
1. **NO ALOJAMOS ARCHIVOS PNG/JPG PESADOS:** 
...
4. **Artworks (Arte externo):** Las obras maestras digitales finales nunca se suben a la app. Forzamos al usuario a alojar su arte en redes convencionales (Instagram, Twitter, Behance) y pegar el Hyperlink en la plataforma para indexarlo localmente mediante la tabla `artworks`.
