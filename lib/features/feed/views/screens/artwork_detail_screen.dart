                          ...
                          errorBuilder: (context, error, stackTrace) => Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(l10n.previewError, style: const TextStyle(color: Colors.grey)),
                              ],
                            ),
                          ),
                        )
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                l10n.viewOnPlatform(Uri.parse(currentArtwork.externalLink).host),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                  ...
                                  children: [
                                    IconButton(
                                      icon: Icon(
                                        ...
                                        color: currentArtwork.isLiked ? Colors.red : null,
                                        size: 28,
                                      ),
                                      onPressed: () {
                                        ref
                                      ...
                                      tooltip: currentArtwork.isLiked ? 'Quitar like' : 'Dar like',
                                    ),
                                ...
                                const Spacer(),
                                ElevatedButton.icon(
                                  onPressed: () => _launchUrl(currentArtwork.externalLink),
