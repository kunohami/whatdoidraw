              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                              ...
                              child: FilledButton.icon(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          DoodleCanvasScreen(ideaId: currentDoodle.ideaId),
                                    ),
                                  );
                                },
                      ...
                      if (_selectedOption == 'idea' && detailState.parentIdea != null)
                        Padding(
                      ...
                      if (_selectedOption == 'artworks')
                        Consumer(
                          builder: (context, ref, _) {
                            final artworksState = ref.watch(doodleDetailArtworksProvider(currentDoodle.id));
                            final artworksNotifier = ref.read(doodleDetailArtworksProvider(currentDoodle.id).notifier);
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (artworksState.isLoading)
                                    ...
                                    Center(child: Text('Error: ${artworksState.errorMessage}'))
