...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,doodleId,previewUrl,externalLink,const DeepCollectionEquality().hash(tags),isActive,createdAt);

@override
String toString() {
  return 'ArtworkModel(id: $id, userId: $userId, doodleId: $doodleId, previewUrl: $previewUrl, externalLink: $externalLink, tags: $tags, isActive: $isActive, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'doodle_id') String? doodleId,@JsonKey(name: 'preview_url') String? previewUrl,@JsonKey(name: 'external_link') String externalLink, List<String> tags,@JsonKey(name: 'is_active') bool isActive,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of ArtworkModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? doodleId = freezed,Object? previewUrl = freezed,Object? externalLink = null,Object? tags = null,Object? isActive = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'doodle_id')  String? doodleId, @JsonKey(name: 'preview_url')  String? previewUrl, @JsonKey(name: 'external_link')  String externalLink,  List<String> tags, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ArtworkModel() when $default != null:
return $default(_that.id,_that.userId,_that.doodleId,_that.previewUrl,_that.externalLink,_that.tags,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'doodle_id')  String? doodleId, @JsonKey(name: 'preview_url')  String? previewUrl, @JsonKey(name: 'external_link')  String externalLink,  List<String> tags, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _ArtworkModel():
return $default(_that.id,_that.userId,_that.doodleId,_that.previewUrl,_that.externalLink,_that.tags,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'doodle_id')  String? doodleId, @JsonKey(name: 'preview_url')  String? previewUrl, @JsonKey(name: 'external_link')  String externalLink,  List<String> tags, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ArtworkModel() when $default != null:
return $default(_that.id,_that.userId,_that.doodleId,_that.previewUrl,_that.externalLink,_that.tags,_that.isActive,_that.createdAt);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,doodleId,previewUrl,externalLink,const DeepCollectionEquality().hash(_tags),isActive,createdAt);
...
/// Create a copy of ArtworkModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? doodleId = freezed,Object? previewUrl = freezed,Object? externalLink = null,Object? tags = null,Object? isActive = null,Object? createdAt = freezed,}) {
