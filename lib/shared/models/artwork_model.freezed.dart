...
@JsonKey(name: 'user_id') String get userId;/// Nombre de usuario del autor (traído mediante JOIN en el Feed).
 String? get authorName;/// Referencia opcional a la idea original del feed.
