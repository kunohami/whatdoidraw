...
class TutorialStep {
  ...
  const TutorialStep({required this.text, this.imagePath});
}
...
class TutorialOverlay extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return Navigator.of(context).push(
      PageRouteBuilder(
        opaque:
            false, // Permite ver la pantalla inferior a través del fondo translúcido
  ...
  static Future<void> showGeneral(
    ...
    return show(context, steps: steps, onComplete: onComplete, onSkip: onSkip);
  }
  ...
  static Future<void> showCreationHubInfo(BuildContext context, dynamic l10n) {
    return show(context, steps: [TutorialStep(text: l10n.infoCreationHub)]);
  }

  /// Muestra la ayuda en la pantalla de Crear Idea.
  static Future<void> showCreateIdeaInfo(BuildContext context, dynamic l10n) {
    return show(context, steps: [TutorialStep(text: l10n.infoCreateIdea)]);
  }

  /// Muestra la ayuda en el Lienzo del Doodle.
  static Future<void> showDoodleCanvasInfo(BuildContext context, dynamic l10n) {
    return show(context, steps: [TutorialStep(text: l10n.infoDoodleCanvas)]);
  }
                      ...
                      Material(
                        ...
                        child: Container(
                          constraints: const BoxConstraints(
                            maxWidth:
                                500, // Evita que en tablets se vea excesivamente ancho
                            minHeight: 150,
                          ),
